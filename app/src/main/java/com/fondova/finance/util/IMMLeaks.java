...
/**
 * See https://gist.github.com/pyricau/4df64341cc978a7de414#file-lifecyclecallbacksadapter-java for more information.
 */
    ...
    private static class ReferenceCleaner
        ...
        private void clearInputMethodManagerLeak() {
            try {
                ...
                Log.i("IMMLeaks", "Unexpected reflection exception", unexpected);
            }
        }
